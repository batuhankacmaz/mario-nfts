...
contract ERC721{
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender),"Msg.sender is now the owner or an approved operator");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        ...
        require(owner == from, "From address is not the owner or approved for transfer");
